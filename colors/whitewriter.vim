...
let g:colors_name = "whitewriter"

hi Cursor          ctermfg=63               guibg=#528BFF
hi Normal          ctermfg=235 ctermbg=255  guifg=#424242 guibg=#FFFFFF
hi Title           ctermfg=235 ctermbg=255  guifg=#424242 guibg=#FFFFFF term=bold   cterm=bold   gui=bold
...
hi WildMenu        ctermfg=235 ctermbg=255  guifg=#424242 guibg=#FFFFFF
hi Folded          ctermfg=232 ctermbg=255  guifg=#080808 guibg=#FFFFFF term=bold cterm=bold gui=bold

" Messages
hi ModeMsg         ctermfg=235 ctermbg=255  guifg=#424242 guibg=#FFFFFF
hi MoreMsg         ctermfg=235 ctermbg=255  guifg=#424242 guibg=#FFFFFF
hi WarningMsg      ctermfg=202 ctermbg=255  guifg=#FF5F00 guibg=#FFFFFF
hi ErrorMsg        ctermfg=199 ctermbg=255  guifg=#E41D91 guibg=#FFFFFF cterm=italic gui=italic

hi Visual          ctermfg=235 ctermbg=153  guifg=#424242 guibg=#C1E7F4
hi SpecialKey      ctermfg=255 ctermbg=NONE
hi NonText         ctermfg=255 ctermbg=NONE  guifg=#FFFFFF guibg=NONE
...
hi PmenuSel        ctermfg=255 ctermbg=234  guifg=#FFFFFF guibg=#1C1C1C
